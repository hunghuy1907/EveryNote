...
import com.hungth.everynote.view.note.CreateNoteFragment;
...
//
//        if (id == R.id.nav_all_acount) {
//            // Handle the camera action
//        } else if (id == R.id.nav_intro) {
//
//        } else if (id == R.id.nav_all_acount) {
//
...
//        }
    ...
    public void showFirstFragment() {
        ...
        fragmentTransaction.add(R.id.frame_home, noteFragment).commit();
    }
}
